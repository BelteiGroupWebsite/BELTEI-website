...
<br>
        ...
        <table class="align-middle table table-hover text-start content-translate-font text-justify" style="border: 3px solid rgb(76, 0, 255);" width="100%">
            ...
            <tr align="left">
                <td width="40%" style="border: 1px solid rgb(76, 0, 255)">
                    <li>English Language Program</li>
                    <li>SFU PAS English Language Program</li>
                </td>
                <td>
                </td>
            </tr>
            <tr align="left">
                <td width="40%" style="border: 1px solid rgb(76, 0, 255)">Pre-University Program UTP Stage I</td>
                <td>
                    <li>និស្សិតនឺងបន្ទទៅកម្មវិធី UTP Stage II</li>
                </td>
            </tr>
            <tr align="left">
                <td width="40%" style="border: 1px solid rgb(76, 0, 255)">UTP Stage II Arts and Social Sciences</td>
                <td>
                    <li>Bachelor of Anthropoogy</li>
                    <li>Bachelor of Archaeology</li>
                    <li>Bachelor of Art and Culture</li>
                    <li>Bachelor of Cognitive Culture</li>
                    <li>Bachelor of Criminology</li>
                    <li>Bachelor of Economics</li>
                    <li>Bachelor of English</li>
                    <li>Bachelor of Film and Video Studies</li>
                    <li>Bachelor of First Nations Studies</li>
