<div class="sidebar min-width-250 max-width-300 position-sticky shadow-sm p-0 m-0 px-1 content-translate-font" >
    ...
    <ul class="text-capitalize f14 ul-none-style w-100 p-0 m-0 unhover-padding" >
        ...
        <a class="d-flex align-items-center justify-content-center px-3 py-2 border border-2 gap-1" href="{{ route('relation.certificate' , ['program'=>1 , 'grade' => 12]) }}" class="list-group-item text-white text-center">
        ...
        <a class="d-flex align-items-center justify-content-center px-3 py-2 border border-2 gap-1" href="{{ route('relation.certificate' , ['program'=>1 , 'grade' => 9]) }}" class="list-group-item text-white text-center">
        ...
        <a class="d-flex align-items-center justify-content-center px-3 py-2 border border-2 gap-1" href="{{ route('relation.certificate' , ['program'=>1 , 'grade' => 6]) }}" class="list-group-item text-white text-center">
            <img class="max-width-50 rounded shadow-sm" src="https://beltei.edu.kh/khm/images/specialevents/graduation_g9_2023_g3/14.jpg" alt="">
            <p class="text-white text-center">
                {{ __('school/app.primaryCertificate') }}
            </p>
        </a>
        {{-- <a href="{{ route('relation.certificate' , ['program'=>1 , 'grade' => 9]) }}" class="list-group-item text-white text-center">សញ្ញាបត្រមធ្យមសិក្សាបឋមភូមិប៊ែលធី</a>
        <a href="{{ route('relation.certificate' , ['program'=>1 , 'grade' => 6]) }}" class="list-group-item text-white text-center">សញ្ញាបត្រមធ្យមសិក្សាបឋមសិក្សាប៊ែលធី</a> --}}
        <a class="list-group-item text-center gold font-bold">{{ __('school/app.ESLProgram') }}</a>
        <a href="{{ route('relation.certificate' , ['program'=>2 , 'grade' => 12]) }}" class="list-group-item text-white text-center">{{ __('school/app.ESLDiploma') }}</a>
        <a href="{{ route('relation.certificate' , ['program'=>2 , 'grade' => 9]) }}" class="list-group-item text-white text-center">{{ __('school/app.ESLlevel6') }}</a>
        <a href="{{ route('relation.certificate' , ['program'=>2 , 'grade' => 6]) }}" class="list-group-item text-white text-center">PRESCHOOL 6</a>
    </ul>
    ...
    <ul class="text-capitalize list-group f14 unhover-padding">
        ...
        <a href="{{ route('relation.english-speaking-12') }}" class="list-group-item text-white text-center">
        ...
        <a href="{{ route('relation.english-speaking-9') }}" class="list-group-item text-white text-center">
        ...
        <a href="{{ route('relation.english-speaking-6') }}" class="list-group-item text-white text-center">
        ...
        <a href="{{ route('relation.english-speaking-3') }}" class="list-group-item text-white text-center">
    ...
    <ul class="text-capitalize list-group f14 unhover-padding">
        ...
        <a href="{{ route('relation.english-debate-12') }}" class="list-group-item text-white text-center">
        ...
        <a href="{{ route('relation.english-debate-9') }}" class="list-group-item text-white text-center">
