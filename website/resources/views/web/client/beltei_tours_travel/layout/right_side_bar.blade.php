<div class="sidebar min-width-250 max-width-300 position-sticky shadow-sm p-0 m-0 px-1 content-translate-font" >
    ...
    <ul class="text-capitalize f14 ul-none-style w-100 p-1 m-0" style="background-color: #21ade3;">
        <a class="w-100" href="/">
            <img class="w-100" src="https://www.belteitour.com.kh/btk/images/bt-home/beltei_domestic_tour.png" alt="">
        </a>
        <a class="w-100" href="/">
            <img class="w-100" src="https://www.belteitour.com.kh/btk/images/bt-home/beltei_outbound_tour.png" alt="">
        </a>
        <a class="w-100" href="/">
