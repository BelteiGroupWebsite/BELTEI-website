...
! function() {
    ...
    var X, q, z, Y, Z = function(e, t) {
        ...
        de = W,
        le = (S(ie), S("iOS"), S(ae), S("Linux"), S("OSX"), S(se), S(ue), S(ce), Y = !(q = function() {
    ...
    function Pe(e, t) {
        var n, r, o = (n = e, be(r = me.fromTag(t), Ne(n)), r);
    ...
    function Xe(e) {
        var t, n, r = e.selection.getSelectedBlocks();
    ...
    function et(u, e, c) {
        ...
        return w(t).each(function(e) {
            var t, n, r, o, i, a, s = (t = c.itemAttributes, n = c.content, be(r = me.fromTag("li", u), t), ke(r, n), r);
    ...
    function at(s) {
        return b(s, function(a, e) {
            ...
            i = (r = s)[o = e].depth, h(D(r.slice(0, o)), t, n).orThunk(function() {
                ...
                var e, t, n, r, o, i;
                a.dirty && (a.listAttributes = (e = a.listAttributes, n = function(e, t) {
                    return "start" !== t
                }, r = t = {}, o = function(e, t) {
                    r[t] = e
    ...
    function st(n, a, s, u) {
        return De(u).filter(nt).fold(function() {
            ...
            var r, o, i, e = (r = u, o = n, i = s.get(), Oe(r).filter(Bt).map(function(e) {
                return {
                    depth: o,
                    dirty: !1,
                    isSelected: i,
    ...
    function ut(o, e) {
        return C(at(e), function(e) {
            var t, n, r = (t = e.content, n = document.createDocumentFragment(), b(t, function(e) {
                n.appendChild(e.dom)
            }), me.fromDom(n));
    ...
    function dt(e, t) {
        var n, r, o, i, a, s, u, c, f, d, l, m, p, g = C((i = qe(o = r = e, o.selection.getStart()), a = L(o.selection.getSelectedBlocks(), _t), s = i.toArray().concat(a), zt(r, s)), me.fromDom),
    ...
    function gt(o) {
        function e(e) {
            var t, n = o[e ? "startContainer" : "endContainer"],
    ...
    function vt(o) {
        function e(e) {
            var t, n = t = o[e ? "startContainer" : "endContainer"],
                r = o[e ? "startOffset" : "endOffset"];
    ...
    function bt(e, t, n) {
        var r, o, i, a = n["list-style-type"] || null;
    ...
    function Ot(u, c, f) {
        ...
        "false" !== l.getContentEditable(u.selection.getNode()) && ("DL" === (c = c.toUpperCase()) && (d = "DT"), e = gt(n), t = function(n, e, r) {
            ...
            var t, n, r, o, i, a = e.previousSibling,
                s = e.parentNode;
    ...
    function Tt(e, t, n) {
        var r, o, i, a, s, u, c, f, d, l, m, p, g, v, h, y, S, C = Qe(e),
    ...
    function At(t, e, n) {
        ...
        Fe(t, e) && Fe(t, n) && (Ut(n.lastChild) && (r = n.lastChild), a === n.lastChild && Kt(a.previousSibling) && t.remove(a.previousSibling), (o = n.lastChild) && Kt(o) && e.hasChildNodes() && t.remove(o), $e(t, n, !0) && t.$(n).empty(), function(e, t, n) {
            var r, o, i, a = xt(e, n) ? n.firstChild : n;
