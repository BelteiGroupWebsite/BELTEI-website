                            ...
                            <div class="mt-2">
                                <form wire:submit.prevent="createOrUpdateStudent">
                                    ...
                                    <div class="text-start row px-3">
                                        ...
                                        <div class="form-group col-3">
                                            <label>IELTS No</label>
                                            <input type="file" accept=".jpg,image/jpeg" class="form-control"
                                                wire:model="ielts_no_upload">

                                            @if ($ielts_no_upload)
                                                <img loading="lazy" class="w-100"
                                                    src="{{ $ielts_no_upload->temporaryUrl() }}">
                                            @elseif ($studentInfoShow)
                                                @php
                                                    $imageCardFolder = 'ielts';
                                                    $imageCard = $studentInfoShow->ielts_no;
                                                    $encryptedProfile = base64_encode(
                                                        "school/$programId/$gradeId/$academicBatch->id/$imageCardFolder/$imageCard.jpg",
                                                    );
                                                @endphp
