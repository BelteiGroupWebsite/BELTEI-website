<div class="">
    <div class="header d-flex align-items-center justify-content-center gap-lg-5  bg-header-color py-2">
        ...
        <div class="text-center gold">
            <h2 class="Muol-Light">មូលនិធិសប្បុរសធម៍ប៊ែលធី</h2>
            <h3 class="Times-New-Roman font-bold">BELTEI CHARITY FOUNDATION</h3>
    ...
    <div class="text-center">
        <a href="{{ route('charity.about.belteigroup', ['goto' => "content"]) }}" class="text-center">
