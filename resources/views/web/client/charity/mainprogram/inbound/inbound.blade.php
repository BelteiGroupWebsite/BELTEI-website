        ...
        <div class="my-3">
            ...
            <div class="container">
                ...
                <div class="row row-cols-lg-2 g-2 g-lg-4">
                    <a href="{{ route('charity.mainprogram.inbound.detail') }}?id=1" class="col">
                    ...
                    <a href="{{ route('charity.mainprogram.inbound.detail') }}?id=2" class="col">
                        <div class="p-3 border bg-light shadow rounded scale-9-hover">
                    ...
                    <a href="{{ route('charity.mainprogram.inbound.detail') }}?id=3" class="col">
                        <div class="p-3 border bg-light shadow rounded scale-9-hover">
                            <img class="w-80"
                    ...
                    <a href="{{ route('charity.mainprogram.inbound.detail') }}?id=4" class="col">
                        <div class="p-3 border bg-light shadow rounded scale-9-hover">
                            <img class="w-80"
                    ...
                    <a href="{{ route('charity.mainprogram.inbound.detail') }}?id=5" class="col">
                        <div class="p-3 border bg-light shadow rounded scale-9-hover">
                    ...
                    <a href="{{ route('charity.mainprogram.inbound.detail') }}?id=6" class="col">
                        <div class="p-3 border bg-light shadow rounded scale-9-hover">
                    ...
                    <a href="{{ route('charity.mainprogram.inbound.detail') }}?id=7" class="col">
                        <div class="p-3 border bg-light shadow rounded scale-9-hover">
                    ...
                    <a href="{{ route('charity.mainprogram.inbound.detail') }}?id=8" class="col">
                        <div class="p-3 border bg-light shadow rounded scale-9-hover">
                    ...
                    <a href="{{ route('charity.mainprogram.inbound.detail') }}?id=9" class="col">
                        <div class="p-3 border bg-light shadow rounded scale-9-hover">
                    ...
                    <a href="{{ route('charity.mainprogram.inbound.detail') }}?id=10" class="col">
                        <div class="p-3 border bg-light shadow rounded scale-9-hover">
                    ...
                    <a href="{{ route('charity.mainprogram.inbound.detail') }}?id=11" class="col">
                        <div class="p-3 border bg-light shadow rounded scale-9-hover">
                    ...
                    <a href="{{ route('charity.mainprogram.inbound.detail') }}?id=12" class="col">
                        <div class="p-3 border bg-light shadow rounded scale-9-hover">
                    ...
                    <a href="{{ route('charity.mainprogram.inbound.detail') }}?id=13" class="col">
                        <div class="p-3 border bg-light shadow rounded scale-9-hover">
                    ...
                    <a href="{{ route('charity.mainprogram.inbound.detail') }}?id=14" class="col">
                        <div class="p-3 border bg-light shadow rounded scale-9-hover">
