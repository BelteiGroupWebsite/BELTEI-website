...
@section('content')
    <div class="p-lg-3">
        ...
        <h2 class="title-translate-font my-3 underline">{{ __('charity/regconition/international.header') }}</h2>
        ...
        <div class="text-start content-translate-font text-justify ">
            {!! __('charity/regconition/international.description', [
                'url' => route('charity.recognition.international'),
            ]) !!}
        </div>
