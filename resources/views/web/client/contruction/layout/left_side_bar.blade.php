<div class="sidebar max-width-250 w-100 shadow-sm p-0 m-0 content-translate-font px-1">
    <ul class="text-capitalize list-group f14">
        <a href="{{ route('contruction.') }}">
            <h6 class="text-uppercase text-center py-2 bg-header-color gold ">{{ __('construction/app.A') }}</h6>
        </a>
        ...
        <a href="{{ route('contruction.about.vision') }}" class="list-group-item text-white">{{ __('beltei_tours_travel/app.A3') }}</a>
        <a href="{{ route('contruction.about.history') }}" class="list-group-item text-white">{{ __('beltei_tours_travel/app.A4') }}</a>
    </ul>
