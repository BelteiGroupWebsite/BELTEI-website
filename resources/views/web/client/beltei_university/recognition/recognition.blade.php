    ...
    <div>
        ...
        <table class="table table-bordered table-hover content-translate-font vertical-align-middle" id="box-table-a"
            ...
            <tbody>
                ...
                <tr>
                    <td>៦</td>
                    <td><a href="{{ route('beltei_university.recognition.recognitiondetail') }}?id=7">វិញ្ញាបនបត្របញ្ចាក់ប្រព័ន្ធគ្រប់គ្រងគុណភាពថ្នាក់ជាតិ​
                            លេខ QMS 006/12 CCD-ISC ថ្ងៃទី១៧ កញ្ញា ២០១២</a></td>
                ...
                <tr>
                    <td>១២</td>
                    <td><a href="{{ route('beltei_university.recognition.recognitiondetail') }}?id=1">វិញ្ញាបនបត្រទទួលស្គាល់គុណភាពអប់រេញពី
                            ACC លេខ គ.ទ.ក ០១១២០៧២១ FA ចុះថ្ងៃទី២៩ ខែមិថុនា ឆ្នាំ២០២២</a></td>
