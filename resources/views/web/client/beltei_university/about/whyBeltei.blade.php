...
@section('content')
    <div class="p-lg-3">
        ...
        <div>
            ...
            <div class="row mt-2">
                <div class="col-6 p-2">
                    <img class="text-center" src="{{ asset('asset/img/university/about/1.png') }}" alt="">
                </div>
                <div class="col-6 p-2">
                    <img class="text-center" src="{{ asset('asset/img/university/about/2.png') }}" alt="">
                </div>
                <div class="col-6 p-2">
                    <img class="text-center" src="{{ asset('asset/img/university/about/3.png') }}" alt="">
                </div>
                <div class="col-6 p-2">
                    <img class="text-center" src="{{ asset('asset/img/university/about/4.png') }}" alt="">
                </div>
            </div>
        </div>
