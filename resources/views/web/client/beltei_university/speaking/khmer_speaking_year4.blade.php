    ...
    <div class="px-2">
        ...
        <div>
            <iframe class="w-100 aspect-ratio-16"
                src="https://www.youtube.com/embed/cBoCmimVUm0?si=mhpzod3BjZm6LePQ"></iframe>
        </div>
        ...
        <div class="row">
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm " width="" height=""
                    src="https://www.youtube.com/embed/cBoCmimVUm0?si=mhpzod3BjZm6LePQ" title="YouTube video player"
                    frameborder="0"
            ...
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm " width="" height=""
                    src="https://www.youtube.com/embed/rhurJc8PfzE?si=8RctBx_WbbHPAZZ5" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <p class="goldenrod font-bold">
            ...
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm " width="" height=""
                    src="https://www.youtube.com/embed/_ujJv00Q3Rg?si=LBg7jHAA7JksFFIB" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <p class="goldenrod font-bold">
