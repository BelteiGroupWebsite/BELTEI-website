...
@section('content')
    <div class="px-2">
        ...
        <h3 class="title-translate-font p-3 bg-success text-white">{{ __('school/public-speaking/public-speaking.header') }}
        </h3>
        <hr>
        <div>
            <iframe class="w-100 aspect-ratio-16"
                src="https://www.youtube.com/embed/1rpM5G-Bvzc?si=xT_0uXDo0YBsSDuM"></iframe>
        </div>
        ...
        <div class="row">
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm " width="" height=""
                    src="https://www.youtube.com/embed/1rpM5G-Bvzc?si=xT_0uXDo0YBsSDuM" title="YouTube video player"
                    frameborder="0"
            ...
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm " width="" height=""
                    src="https://www.youtube.com/embed/w3zqAoASq1k?si=w34QcOvnEi0xLdM9" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                <p class="goldenrod font-bold">
            ...
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm " width="" height=""
                    src="https://www.youtube.com/embed/VPoNYaOEGCA?si=B-rG1MhrWH_EEJDc" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                <p class="goldenrod font-bold">
