    ...
    <div>
        ...
        <table class="table table-hover table-bordered text-center">
            ...
            <tr>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/1.png') }}" alt="Image 1" class="w-100"></td>
            </tr>
            <tr>
                <td>2</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/2.png') }}" alt="Image 2" class="w-100"></td>
            </tr>
            <tr>
                <td>3</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/3.png') }}" alt="Image 3" class="w-100"></td>
            </tr>
            <tr>
                <td>4</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/4.png') }}" alt="Image 4" class="w-100"></td>
            </tr>
            <tr>
                <td>5</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/5.png') }}" alt="Image 5" class="w-100"></td>
            </tr>
            <tr>
                <td>6</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/6.png') }}" alt="Image 6" class="w-100"></td>
            </tr>
            <tr>
                <td>7</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/7.png') }}" alt="Image 7" class="w-100"></td>
            </tr>
            <tr>
                <td>8</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/8.png') }}" alt="Image 8" class="w-100"></td>
            </tr>
            <tr>
                <td>9</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/9.png') }}" alt="Image 9" class="w-100"></td>
            </tr>
            <tr>
                <td>10</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/10.png') }}" alt="Image 10" class="w-100"></td>
            </tr>
            <tr>
                <td>11</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/11.png') }}" alt="Image 11" class="w-100"></td>
            </tr>
            <tr>
                <td>12</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/12.png') }}" alt="Image 12" class="w-100"></td>
            </tr>
            <tr>
                <td>13</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/13.png') }}" alt="Image 13" class="w-100"></td>
            </tr>
            <tr>
                <td>14</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/14.png') }}" alt="Image 14" class="w-100"></td>
            </tr>
            <tr>
                <td>15</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/15.png') }}" alt="Image 15" class="w-100"></td>
            </tr>
            <tr>
                <td>16</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/16.png') }}" alt="Image 16" class="w-100"></td>
            </tr>
            <tr>
                <td>17</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/17.png') }}" alt="Image 17" class="w-100"></td>
            </tr>
            <tr>
                <td>18</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/18.png') }}" alt="Image 18" class="w-100"></td>
            </tr>
            <tr>
                <td>19</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/19.png') }}" alt="Image 19" class="w-100"></td>
            </tr>
            <tr>
                <td>20</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/20.png') }}" alt="Image 20" class="w-100"></td>
            </tr>
            <tr>
                <td>21</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/21.png') }}" alt="Image 21" class="w-100"></td>
            </tr>
            <tr>
                <td>22</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/22.png') }}" alt="Image 22" class="w-100"></td>
            </tr>
            <tr>
                <td>23</td>
                ...
                <td><img src="{{ asset('asset/img/university/app/rightsidebar/cambodia/photo/23.png') }}" alt="Image 23" class="w-100"></td>
            </tr>
        </table>
