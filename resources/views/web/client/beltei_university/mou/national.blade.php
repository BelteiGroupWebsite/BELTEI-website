        ...
        <table class="table table-hover table-bordered text-center vertical-align-middle">
            ...
            @for ($i = 1; $i <= 40; $i++)
                <tr>
                    ...
                    <td>
                        @if ($linkArr[$i - 1] !== 'N/A')
                            <a href="{{ $linkArr[$i - 1] }}" target="_blank">
                                <img loading="lazy" style="max-height:80px; max-width: 200px" src="{{ asset("asset/img/university/mou/national/logo/{$i}.png") }}" alt="Logo {{ $i }}">
                            </a>
                        @else
                            <img loading="lazy" style="max-height:80px; max-width: 200px" src="{{ asset("asset/img/university/mou/national/logo/{$i}.png") }}" alt="Logo {{ $i }}">
                        @endif
                    ...
                    <td>
                        <img loading="lazy" src="{{ asset("asset/img/university/mou/national/image/{$i}.jpg") }}" alt="Image {{ $i }}" style="max-height:150px;">
                    </td>
                </tr>
            @endfor
