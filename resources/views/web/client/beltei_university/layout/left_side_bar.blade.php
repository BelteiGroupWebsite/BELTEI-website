...
<div class="sidebar max-width-250 w-100 shadow-sm p-0 m-0 content-translate-font px-1">
    ...
    <ul style="background-color: #21ade3" class="text-capitalize list-group f14 ">
        ...
        <a href="{{ route('beltei_university.faculty-detail') }}?id=1" style=" text-shadow: 2px 2px 2px #21ade3;" class="list-group-item title-translate-font py-4 BBA-color-bg border border-2 border-bottom-0 Gold-color-border text-white d-flex align-items-center">{{ __('beltei_university/app.C1') }}</a>
        <a href="{{ route('beltei_university.faculty-detail') }}?id=2" style=" text-shadow: 2px 2px 2px #21ade3" class="list-group-item title-translate-font py-4 BFB-color-bg border border-2 border-bottom-0 Gold-color-border text-white d-flex align-items-center">{{ __('beltei_university/app.C2') }}</a>
        <a href="{{ route('beltei_university.faculty-detail') }}?id=3" style=" text-shadow: 2px 2px 2px #21ade3" class="list-group-item title-translate-font py-4 BEco-color-bg border border-2 border-bottom-0 Gold-color-border text-white d-flex align-items-center">{{ __('beltei_university/app.C3') }}</a>
        <a href="{{ route('beltei_university.faculty-detail') }}?id=4" style=" text-shadow: 2px 2px 2px #21ade3" class="list-group-item title-translate-font py-4 BLaw-color-bg border border-2 border-bottom-0 Gold-color-border text-white d-flex align-items-center">{{ __('beltei_university/app.C4') }}</a>
        <a href="{{ route('beltei_university.faculty-detail') }}?id=5" style=" font-size: 12px ; text-shadow: 2px 2px 2px #21ade3" class="list-group-item title-translate-font py-4 BEdu-color-bg border border-2 border-bottom-0 Gold-color-border text-white d-flex align-items-center">{{ __('beltei_university/app.C5') }}</a>
        <a href="{{ route('beltei_university.faculty-detail') }}?id=6" style=" font-size: 12px ;text-shadow: 2px 2px 2px #21ade3" class="list-group-item title-translate-font py-4 BTh-color-bg border border-2 border-bottom-0 Gold-color-border text-white d-flex align-items-center">{{ __('beltei_university/app.C6') }}</a>
        <a href="{{ route('beltei_university.faculty-detail') }}?id=7" style=" font-size: 12px ; text-shadow: 2px 2px 2px #21ade3" class="list-group-item title-translate-font py-4 BIT-color-bg border border-2 border-bottom-0 Gold-color-border text-white d-flex align-items-center">{{ __('beltei_university/app.C7') }}</a>
        <a href="{{ route('beltei_university.faculty-detail') }}?id=8" style=" font-size: 10px ; text-shadow: 1px 1px 1px #21ade3" class="list-group-item title-translate-font py-4 BDT-color-bg border border-2 border-bottom-0 Gold-color-border text-white d-flex align-items-center">{{ __('beltei_university/app.C8') }}</a>
        <a href="{{ route('beltei_university.faculty-detail') }}?id=9" style=" text-shadow: 2px 2px 2px #21ade3" class="list-group-item title-translate-font py-4 BEng-color-bg border border-2 border-bottom-0 Gold-color-border text-white d-flex align-items-center">{{ __('beltei_university/app.C9') }}</a>
        <a href="{{ route('beltei_university.faculty-detail') }}?id=10" style=" text-shadow: 2px 2px 2px #21ade3" class="list-group-item title-translate-font py-4 BArch-color-bg border border-2 border-bottom-0 Gold-color-border text-white d-flex align-items-center">{{ __('beltei_university/app.C10') }}</a>
        <a href="{{ route('beltei_university.faculty-detail') }}?id=11" style=" text-shadow: 2px 2px 2px #21ade3" class="list-group-item title-translate-font py-4 BIR-color-bg border border-2 border-bottom-0 Gold-color-border text-white d-flex align-items-center">{{ __('beltei_university/app.C11') }}</a>
        <a href="{{ route('beltei_university.faculty-detail') }}?id=12" style=" text-shadow: 2px 2px 2px #21ade3" class="list-group-item title-translate-font py-4 BCA-color-bg border border-2 border-bottom-0 Gold-color-border text-white d-flex align-items-center">{{ __('beltei_university/app.C12') }}</a>
        <a href="{{ route('beltei_university.faculty-detail') }}?id=13" style=" text-shadow: 2px 2px 2px #21ade3 ; background: #FFC62A;" class="list-group-item title-translate-font py-4  border border-2 border-bottom-0 Gold-color-border text-white d-flex align-items-center">{{ __('beltei_university/app.C13') }}</a>
