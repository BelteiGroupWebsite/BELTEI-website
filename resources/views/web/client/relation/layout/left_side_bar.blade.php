<div class="sidebar min-width-250 max-width-300 shadow-sm p-0 m-0 content-translate-font px-1">
    <ul class="text-capitalize list-group f14">
        <a href="{{ route('relation.') }}">
            <h6 class="text-uppercase text-center py-2 bg-header-color gold ">{{ __('relation/app.A') }}</h6>
        </a>
        <a href="{{ route('relation.about.welcome') }}" class="list-group-item text-white">{{ __('relation/app.A1') }}</a>
        <a href="{{ route('relation.about.purpose') }}" class="list-group-item text-white">{{ __('relation/app.A2') }}</a>
    ...
    <ul class="text-capitalize list-group f14">
        ...
        <a href="{{ route('relation.partner_university.taylor') }}" class="list-group-item text-white">{{ __('relation/app.F7') }}</a>

        <a href="{{ route('relation.') }}"><h6 class="text-uppercase text-center py-2 BTh-color-bg gold ">{{ __('relation/app.F8') }}</h6></a>
        <a href="{{ route('relation.partner_university.curtin') }}" class="list-group-item text-white">{{ __('relation/app.F9') }}</a>
        <a href="{{ route('relation.partner_university.easb') }}" class="list-group-item text-white">{{ __('relation/app.F10') }}</a>
