...
@section('content')
    <div class="px-2">
        ...
        <div class="row">
            ...
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm " width="" height=""
                    src="https://www.youtube.com/embed/bG5u-SnTtdg?si=zRUIOLDibOJL7Y3w" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <p class="goldenrod font-bold">
            ...
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm " width="" height=""
                    src="https://www.youtube.com/embed/OIm2hRX0X8E?si=RVjkMh3u6SJQmAjk" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <p class="goldenrod font-bold">
        ...
        <div class="row">
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm "
                    src="https://www.youtube.com/embed/c8DNqgZQ13c?si=IUS-3ZqoBcLEAhzK" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <p class="goldenrod font-bold">
            ...
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm "
                    src="https://www.youtube.com/embed/TrZy-aWSpl4?si=gGtGNIgbB17-qDci" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <p class="goldenrod font-bold">
            ...
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm "
                    src="https://www.youtube.com/embed/DsQ8YluxRgw?si=kPQp-U4bCZqkVmP3" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <p class="goldenrod font-bold">
        ...
        <div class="row">
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm "
                    src="https://www.youtube.com/embed/LAZimHe0Zus?si=jfSHYLoNvs8dvgrc" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <p class="goldenrod font-bold">
            ...
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm "
                    src="https://www.youtube.com/embed/esaYp2X2TAs?si=OwSeBvrlO5UdXO80" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <p class="goldenrod font-bold">
            ...
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm "
                    src="https://www.youtube.com/embed/PmXCZ7Whm0c?si=5PnflNWGplldujt_" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <p class="goldenrod font-bold">
        ...
        <div class="row">
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm "
                    src="https://www.youtube.com/embed/i846AGaVFRk?si=yR5WtvZdExpvhzvD" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <p class="goldenrod font-bold">
            ...
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm "
                    src="https://www.youtube.com/embed/8-xZTr5g6PE?si=4ulhUyN-Khya0B0I" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            ...
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm "
                    src="https://www.youtube.com/embed/3RFNGvq2sXM?si=d-EXgneRpiVUdd_9" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <p class="goldenrod font-bold">
        ...
        <div class="row">
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm "
                    src="https://www.youtube.com/embed/5o5EQzefWfs?rel=0&autoplay=1" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <p class="goldenrod font-bold">
        ...
        <div class="row">
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm "
                    src="https://www.youtube.com/embed/yQYABKPHx0Q?si=QzGLOQy_ipK8LzrX" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <p class="goldenrod font-bold">
            ...
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm "
                    src="https://www.youtube.com/embed/Lw0Xc1sbLJ8?si=Rr9pq6phshAfx5gM" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <p class="goldenrod font-bold">
            ...
            <div class="col-4 height-200 content-translate-font">
                <iframe class="w-100 rounded shadow-sm "
                    src="https://www.youtube.com/embed/ruThfyOnv-E?si=3ei7SvxBSLAuI_2l" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <p class="goldenrod font-bold">
