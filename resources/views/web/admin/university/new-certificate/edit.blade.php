    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.university.certificate-new.update' , $academicBatch->id) }}" method="post" enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                    <div class="row">
                        ...
                        <div class="row mb-3 me-0 pe-0" id="academicYearDiv">
                            <div class="col-12 mb-3">
                                ...
                                <select required name="degree" id="degree" class="form-control">
                                    ...
                                    @foreach ($degrees as $degree)
                                        <option value="{{ $degree->id }}" @if($degree->id == $academicBatch->degree_id) selected @endif>{{ $degree->degree_eng }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-6 mb-3">
                                <label for="batch" class="form-label">Batch <i class="text-danger">*</i></label>
                                <input class="form-control" value="{{ $academicBatch->batch }}" required name="batch" id="batch" type="number" placeholder="18" min="1">
                                @error('batch')
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input class="form-control" value="{{ $academicBatch->academic_year }}" name="startAcademicYear" id="startAcademicYear" type="number" placeholder="YYYY / 2022" min="1970" max="9999">
