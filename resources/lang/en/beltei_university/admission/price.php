...
<!-- 1. Tuition Fee for National Program -->
<div>
  <h4 class="title-translate-font mb-2 text-start"> 1. Tuition Fee for National Program </h4>
  <table class="table table-hover table-bordered fee-table text-center">
    <tr class="bg-primary title-translate-font text-white">
      <th class="text-start">Bachelor / Associate Degree</th>
      <th>Semester 1</th>
      <th>Semester 2</th>
      <th>Semester 3</th>
      <th>Semester 4</th>
    ...
    <tr>
      <td class="text-start">General Faculties</td>
      <td>$400</td>
      <td>$400</td>
      <td>$400</td>
      <td>$400</td>
    ...
    <tr>
      <td class="text-start">Faculty of Information Technology</td>
      <td>$450</td>
      <td>$450</td>
      <td>$450</td>
      <td>$450</td>
...
<!-- 2. Tuition Fee for International Program -->
<div>
  ...
  <table class="table table-hover table-bordered text-center">
    ...
    <tr>
      <td class="text-start">Faculty of Civil Aviation <img style="max-width: 150px" src="https://beltei.edu.kh/asset/img/university/admission/price/plane.png" alt=""></td>
      <td>$1,000</td>
      <td>$1,000</td>
      <td>$1,000</td>
      <td>$1,000</td>
...
<div>
  ...
  <table class="table table-hover table-bordered">
    ...
    <tr>
      <td> Morning </td>
      <td> 08:00AM – 11:15AM </td>
    </tr>
    <tr>
      <td> Afternoon </td>
      <td> 02:00PM – 05:15PM </td>
    </tr>
    <tr>
      <td> Evening </td>
