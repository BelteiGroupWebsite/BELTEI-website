...
! function() {
    ...
    var i, o = tinymce.util.Tools.resolve("tinymce.PluginManager"),
        v = function() {
    ...
    function oe(t, e) {
        ...
        b ? (n = Y(function(e) {
            return ne(t, e)
        }, b), r = v(v({}, n), e), s = t, c = r.src, i = v(v({}, r), {
            src: R(s, c) ? c : ""
        ...
        }, f.onerror = y)) : (a = t, (o = b) && (l = a.dom.is(o.parentNode, "figure.image") ? o.parentNode : o, a.dom.remove(l), a.focus(), a.nodeChanged(), a.dom.isEmpty(a.getBody()) && (a.setContent(""), a.selection.setCursorLocation())))) : e.src && ae(t, v(v({}, Q()), e))
    }
    ...
    function ce(e) {
        ...
        return S([
            ...
            [v(v({}, e.classList.isSome() && e.hasImageCaption ? {
                type: "grid",
                columns: 2
            } : {
                type: "panel"
                ...
                r = v, i = Pe(function(e) {
                    ...
                    return {
                        ...
                        body: (r = e).hasAdvTab || r.hasUploadUrl || r.hasUploadHandler ? {
                            type: "tabpanel",
                            tabs: S([
                                [ke(r)], r.hasAdvTab ? [Re(r)] : [], r.hasUploadTab && (r.hasUploadUrl || r.hasUploadHandler) ? [Me(r)] : []
                            ])
                        } : {
                            type: "panel",
                            items: ze(r)
    ...
    function he(a) {
        return function(e) {
            for (var t = e.length, n = function(e) {
    ...
    var ye, ve = be,
        ...
        Ne = function(e, a) {
            ...
            return Te.each(e, function(e) {
                var t, n, r, i = T((t = e).text) ? t.text : T(t.title) ? t.title : "";
